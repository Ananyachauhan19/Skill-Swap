            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <a href="/profile/panel/your-home" className="text-gray-800 hover:text-blue-700 hover:underline transition-all duration-300 flex items-center gap-2">
                      <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                      Learning Sessions
                    </a>
                  </li>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    ...
                    className="group relative flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 hover:scale-110 hover:shadow-lg"
                  >
                    ...
                    <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-blue-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">Instagram</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-blue-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">WhatsApp</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 bg-blue-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">LinkedIn</span>
                  </a>
                  ...
                  <a
                    ...
                    className="group relative flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-gray-100 to-gray-50 border-2 border-gray-300 opacity-50 cursor-not-allowed"
                  >
