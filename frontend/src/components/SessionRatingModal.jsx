...
const SessionRatingModal = ({ open, onSubmit, sessionType = 'Session', expertName = '', }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      <form className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full relative flex flex-col gap-4" onSubmit={handleSubmit}>
        <h3 className="text-xl font-bold mb-2 text-blue-800">Rate Your {sessionType}</h3>
        <div className="text-blue-700 mb-2">{expertName && `Expert: ${expertName}`}</div>
