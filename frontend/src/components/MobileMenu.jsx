  ...
  >
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 pt-5 pb-2 border-b border-blue-100">
        <div className="flex items-center gap-2">
          <img
            ...
            className="h-9 w-7 object-cover rounded-full shadow border-2 border-blue-900"
          />
      ...
      <div className="px-2 py-2 border-t border-blue-100 max-h-40 overflow-y-auto">
        <Notifications notifications={notifications} setNotifications={setNotifications} iconSize="w-2 h-2"/>
      </div>
        ...
        {isLoggedIn ? (
          <>
            <button
              ...
              className="w-full bg-blue-100 text-blue-800 px-3 py-1.5 rounded-full font-medium text-sm shadow-sm hover:bg-blue-200 hover:text-blue-900 transition hover:scale-[1.02]"
            >
              Profile
            </button>
            {showProfileMenu && (
