...
const TopInterviewers = () => {
  ...
  const fetchTopInterviewers = async () => {
    ...
    try {
      ...
      for (const r of list) {
        ...
        if (inter) byInterviewer.set(String(inter), (byInterviewer.get(String(inter)) || 0) + 1);
  ...
  return (
    <section className="relative rounded-3xl mb-8 w-full max-w-7xl mx-auto overflow-hidden bg-white shadow-lg">
      <div className="relative z-10 px-4 sm:px-8 lg:px-12 py-8 sm:py-12 flex flex-col gap-8 sm:gap-10">
        {/* Header */}
