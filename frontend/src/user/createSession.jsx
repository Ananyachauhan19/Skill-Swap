...
const CreateSessionNew = () => {
  ...
  if (nonTutorBlocked) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-blue-100 pt-12 sm:pt-14 md:pt-16 xl:pt-20 pb-8 px-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16 md:pt-[72px] xl:pt-20 font-inter">
