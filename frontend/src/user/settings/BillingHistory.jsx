  ...
  return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
        <h2 className="text-2xl font-semibold text-blue-900 text-center mb-6">Billing History</h2>
        ...
        {loading ? (
          ...
          <div className="text-center text-blue-600">No billing history found.</div>
        ) : (
              ...
              <tbody>
                {history.map((item, i) => (
                  <tr key={i} className="border-t border-blue-100">
                    ...
                    <td className="py-3 px-4 text-blue-900">{item.description}</td>
                    <td className="py-3 px-4 text-blue-900">{item.amount}</td>
                    <td className="py-3 px-4 text-blue-900">{item.status}</td>
                  </tr>
                ))}
              </tbody>
            </table>
