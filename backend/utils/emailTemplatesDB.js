...
module.exports = {
  ...
  interviewRescheduled: async (variables) => await getEmailTemplate('interviewRescheduled', variables),
  interviewRescheduledInterviewer: async (variables) => await getEmailTemplate('interviewRescheduledInterviewer', variables),
